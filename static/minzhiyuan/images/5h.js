...
*/
    ...
    if ("mengniu.com.cn" == location.host || "www.mengniu.com.cn" == location.host) { fb(""); var Vd = "//stm-" + ("https:" === location.protocol ? "collect" : "cdn") + ".cn.miaozhen.com/"; w.stm_clicki("require", "heatmap", Vd + "plugins/heatmap.js"); w.stm_clicki("heatmap:on", 5); fb(Vd + "clicki.min.js") } zc = w.isWeb;
    Qa(function () {
